...
const CreateAccount = () => {
  ...
  const submitUserData = async (e) => {
    ...
    if (!name || !phone || !email || !password || !confirm_password) {
      ...
      const responce = await axios.post(
        "https://achieverbackend.onrender.com/register",
        {
          name: name,
          phone: phone,
          email: email,
  ...
  return (
    <div className="flex justify-between -top-3">
      <div className="w-[529px] h-[610px] hidden md:block  bg-gradient-to-b from-[#4B006E] to-[#FF6584] relative z-0">
        <img
        ...
        <form className="text-sm">
          <div className="flex gap-4 mt-5 ml-32 text-lato font-normal">
            <input
              ...
              className="rounded-full border-2 ml-2 p-3 w-60 h-9 border-[#8B8989] bg-[#100D0F]"
            />
            <input
              onChange={(e) =>
              ...
              className="rounded-full border-2 w-60 p-3 h-9 border-[#8B8989] bg-[#100D0F]"
            />
          </div>
          ...
          <input
            ...
            className="rounded-full w-[500px] ml-32 mt-3 p-3 border-2  h-9 border-[#8B8989] bg-[#100D0F]"
          />
          ...
          <div className="flex gap-4 mt-3 ml-32 text-lato font-normal">
            <input
              ...
              className="rounded-full border-2 ml-3 w-60 p-3 h-9 border-[#8B8989] bg-[#100D0F]"
            />
            <input
              onChange={(e) =>
          ...
          <input
            onChange={(e) =>
              setUserInput({ ...userInput, referal: e.target.value })
            }
            type="email"
            name="referal"
          ...
          <div className="flex gap-2 ml-36">
            ...
            <p className="mt-5 text-xs">
              By continuing, you agree to Name’s Terms of Service & Privacy
              Policy
            </p>
          </div>
          ...
          <button
            ...
            className="w-[500px] h-9 ml-32 mt-5 rounded-full bg-[#4B006E] leading-7 font-bold text-white"
          >
            Continue
          </button>

          <span className="flex text-sm gap-2 mt-2 justify-center">
            <p className="font-lato  font-normal ml-12 text-[#8E8B8B]">
              Already have an account?
            </p>
            <Link to="/login">
              <button className=" text-[#FF6584] text-sm">Click Here</button>
            </Link>
          </span>
        </form>
      </div>
